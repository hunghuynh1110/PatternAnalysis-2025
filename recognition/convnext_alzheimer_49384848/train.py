...
Original file is located at
    https://colab.research.google.com/drive/14nTMERYmI8jCpLiLSJZxLaYdUPQUTyK9
"""
...
total_epochs = EPOCHS
explore_end_epoch    = int(total_epochs * 0.75)   # e.g. first 50%
transition_end_epoch = int(total_epochs * 0.9) # next ~33%
